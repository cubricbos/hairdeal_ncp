...
async function run() {
  ...
  } catch(e) { console.log('get designer/all direct err:', e?.response?.status) }
  ...
  } catch(e) { console.log('get api/account/designer/all direct err:', e?.response?.status) }
  ...
  } catch(e) { console.log('get https api/designer/all err:', e?.response?.status) }
  ...
  } catch (e) { console.log('post mobile login err:', e?.response?.status, e?.response?.data) }
}
run();
